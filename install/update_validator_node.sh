...
update_validator() {
  ...
  cmd="https://github.com/NEWSOROS/sv-manager-2/archive/refs/tags/$3.zip"
  echo "starting $cmd"
...
echo '### /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/NEWSOROS/sv-manager-2/latest/install/install_monitoring.sh)" ###'
fi
